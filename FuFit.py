...
# - blob parameters
agnpy_ssc.delta_D.quantity = 1.6
agnpy_ssc.delta_D.frozen = True
agnpy_ssc.log10_B.quantity =  1.5109e-01
...
agnpy_ssc.p2.quantity = 4.1200e+00
...
agnpy_ssc.log10_gamma_min.quantity = 2.0500e+00
agnpy_ssc.log10_gamma_min.frozen = True
agnpy_ssc.log10_gamma_max.quantity = np.log10(3*10**4) +3.2
