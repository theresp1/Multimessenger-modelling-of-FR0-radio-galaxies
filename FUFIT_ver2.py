...
# - blob parameters
agnpy_ssc.delta_D.quantity = 1.4 
agnpy_ssc.delta_D.frozen = True
agnpy_ssc.log10_B.quantity =  1.6609e-01
...
agnpy_ssc.p1.quantity = 1.9770e+00
agnpy_ssc.p2.quantity = 4.1 
agnpy_ssc.p1.frozen = True
agnpy_ssc.p2.frozen = True
agnpy_ssc.log10_gamma_b.quantity = np.log10(2500)
agnpy_ssc.log10_gamma_b.frozen = True
agnpy_ssc.log10_gamma_min.quantity = np.log10(100) 
agnpy_ssc.log10_gamma_min.frozen = True
agnpy_ssc.log10_gamma_max.quantity = np.log10(3*10**4) +2.0
...
#plt.savefig("FUFIT_ver2_fit7/Fit10.png")
#plt.show()
