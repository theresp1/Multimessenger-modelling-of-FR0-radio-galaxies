...
# - EED
agnpy_ssc.log10_k_e.quantity = -3.5359e+00 
...
agnpy_ssc.log10_gamma_b.quantity = np.log10(7000)     #3.3962e+00  #np.log10(2490)
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA58287_fit6.png")
...
plt.savefig("LEDAoutput/LEDA55267_fit6.1.png")
plt.show()
