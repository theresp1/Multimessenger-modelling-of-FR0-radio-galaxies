...
agnpy_ssc.log10_gamma_b.quantity = np.log10(4000)     #3.3962e+00  #np.log10(2490)
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA58287_fit1.png")
...
plt.savefig("LEDAoutput/LEDA58287_fit1.1.png")
plt.show()
