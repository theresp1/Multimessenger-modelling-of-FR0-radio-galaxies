...
class AgnpySSC(SpectralModel):
    ...
    mu_s = Parameter("mu_s", 0.9, min=0.0, max=2.0)
...
M_BH    = 0.2e10 * M_sun   #1e8-1e9 range leave it free 
eta     = 1 / 12
...
# - EED
agnpy_ssc.log10_k_e.quantity = -5.4468e+00 
...
agnpy_ssc.log10_gamma_b.quantity = np.log10(8000)     #3.3962e+00  #np.log10(2490)
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA57137_fit5.png")
...
plt.savefig("LEDAoutput/LEDA57137_fit5.1.png")
plt.show()
