...
x1_lower_error = (0.9962 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
x2_lower_error = (4.2008 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
x3_lower_error = (17.477 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
xu_lower_error = (72.626 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
x1_upper_error = (4.1452 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
x2_upper_error = (17.246 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
x3_upper_error = (72.639 * u.GeV).to(u.Hz, equivalencies=u.spectral()).value
...
up_lim_array_p = np.array([0,0,0,3.4801*10**(-13)])
...
B       = 10**(-1.0000e+00) *u.G
# disk
#L_disk  = 1.75e45 * u.Unit("erg s-1")  # disk luminosity
# M_BH    = 1.0e10 * M_sun   #1e8-1e9 range leave it free 
# eta     = 1 / 12
...
L_disk  = 1.4e45 * u.Unit("erg s-1")  # disk luminosity
...
# - EED
agnpy_ssc.log10_k_e.quantity = -6.0468e+00 
...
agnpy_ssc.log10_gamma_b.quantity = 3.7782e+00     #3.3962e+00  #np.log10(2490)
agnpy_ssc.log10_gamma_b.frozen = True
agnpy_ssc.log10_gamma_min.quantity = 1.0000e+00   #2.0792e+00 
agnpy_ssc.log10_gamma_min.frozen = True
agnpy_ssc.log10_gamma_max.quantity =  6.0912e+00   #np.log10(3.0*10**4)    #5.3802e+00    #np.log10(6.4e5)
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA57137_fit_ver61_1.png")
...
plt.savefig("LEDAoutput/LEDA57137_ver6_1.1.png")
plt.show()
