...
# - blob parameters
agnpy_ssc.delta_D.quantity = 1.5
agnpy_ssc.delta_D.frozen = True
agnpy_ssc.log10_B.quantity =  np.log10(0.08)  
...
agnpy_ssc.t_var.quantity = 7.5710e+06 
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA57137_fit8.png")
...
plt.savefig("LEDAoutput/LEDA57137_fit8.1.png")
plt.show()
