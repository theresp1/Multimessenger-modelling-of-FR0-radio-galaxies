...
# - blob parameters
agnpy_ssc.delta_D.quantity = 1.3
agnpy_ssc.delta_D.frozen = True
agnpy_ssc.log10_B.quantity =  np.log10(0.09)  
...
plt.ylim(1e-20,1e-8)
plt.savefig("LEDAoutput/LEDA55267_fit4.png")
...
plt.savefig("LEDAoutput/LEDA55267_fit4.1.png")
plt.show()
