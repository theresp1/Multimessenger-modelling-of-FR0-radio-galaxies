...
x_u         = (3e3*u.MeV).to(u.Hz,equivalencies=u.spectral()).value
y_u         = 4.8e-13 * 10/13
x1          = 3e3-2.23e3
x2          =4.01e3-3.3e3
...
up_lim_array = np.array([4.8e-13 * 10/13])
...
plt.savefig("LEDAoutput/LEDA31768_fit2_ver6.png")
plt.show()
...
plt.savefig("LEDAoutput/LEDA31768_fit2.2_ver6.png")
plt.show()
