...
#plt.savefig("output/Tol_1326-379_fitting_case3.png")
plt.show()

#agnpy_ssc.covariance.plot_correlation()
#plt.show()
#plt.savefig("output/Tol_1326-379_correlation_case2.png")
#plt.show()
